...
class LabImageRecordWriter(RecordWriter):
    ...
    def write_image(self, img_file, image, img_embedding):
        ...
        example = tf.train.Example(features=tf.train.Features(feature={
            ...
            'image_l': self._float32_list(l.flatten()),
            'image_ab': self._float32_list(ab.flatten()),
    ...
    def _create_read_operation(self):
        features = tf.parse_single_example(
            ...
            features={
                ...
                'image_ab': tf.FixedLenFeature([width * height * 2],
                                               tf.float32),
                'image_embedding': tf.FixedLenFeature(
