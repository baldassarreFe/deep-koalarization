# nofilter: Reversing Image Filters using Image-to-Image Translation Techniques and Transfer Learning
Deep Learning in Data Science - Project Proposal
...
Then we also saw the experiments of Satoshi Izuka, Edgar Simo-Serra and Hiroshi Ishikawa, who added image classification features to raw pixels fed to the network, improving the overall results ([video review](https://www.youtube.com/watch?v=MfaTOXxA8dM), [Blog post](http://hi.cs.waseda.ac.jp/~iizuka/projects/colorization/en/) and [paper](https://github.com/satoshiiizuka/siggraph2016_colorization)).
